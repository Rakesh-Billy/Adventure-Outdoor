                      ...
                      <div className="col-12 col-md-6 col-lg-4">
                        <div className="card" style={{ width: '20rem',margin:'20px auto' }}>
                          ...
                          <div className="card-body">
                            ...
                            <div className="btn-flx" style={{display: 'flex', justifyContent: 'space-between'}}> <Link to='/ananthagiri' className="btn " style={{ backgroundColor: '#54bce4', color: 'white' }}>See Details&nbsp;<i className="fa fa-binoculars"></i></Link>
                              <a onClick={showAlert} className="btn " style={{ backgroundColor: '#228b22', color: 'white' }}>Book Trip&nbsp;<i className="fa fa-shopping-cart"></i></a></div>
                          </div>
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-lg-4">
                        <div className="card" style={{ width: '20rem',margin:'20px auto' }}>
                          ...
                          <div className="card-body">
                            ...
                            <div className="btn-flx" style={{display: 'flex', justifyContent: 'space-between'}}>
                               <Link to='/goa' className="btn " style={{ backgroundColor: '#54bce4', color: 'white' }}>See Details&nbsp;<i className="fa fa-binoculars"></i></Link>
                              <a onClick={showAlert} className="btn " style={{ backgroundColor: '#228b22', color: 'white' }}>Book Trip&nbsp;<i className="fa fa-shopping-cart"></i></a>
                              </div>
                          </div>
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-lg-4">
                        <div className="card" style={{ width: '20rem',margin:'20px auto'  }}>
                          ...
                          <div className="card-body">
                            ...
                            <p style={{ textAlign: 'justify' }}>Coorg & Chikmagalur, located in the Western Ghats of Karnataka, is known for its scenic beauty, coffee plantations, trekking trails, wildlife sanctuaries, waterfalls, and historical sites.</p>
                            <div className="btn-flx" style={{display: 'flex', justifyContent: 'space-between'}}> <Link to='/coorg' className="btn " style={{ backgroundColor: '#54bce4', color: 'white' }}>See Details&nbsp;<i className="fa fa-binoculars"></i></Link>
                              <a onClick={showAlert} className="btn " style={{ backgroundColor: '#228b22', color: 'white' }}>Book Trip&nbsp;<i className="fa fa-shopping-cart"></i></a></div>
                          </div>
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-lg-4">
                        <div className="card" style={{ width: '20rem',margin:'20px auto' }}>
                          ...
                          <div className="card-body">
                            ...
                            <p style={{ textAlign: 'justify' }}>One of the most adored hill stations of Tamil Nadu situated in the Nilgiri Hills of the Western Ghats of southern India, Ooty, is often visited by innumerable tourists to enjoy the peace and calm.</p>
                            <div className="btn-flx" style={{display: 'flex', justifyContent: 'space-between'}}> <Link to='/ooty' className="btn " style={{ backgroundColor: '#54bce4', color: 'white' }}>See Details&nbsp;<i className="fa fa-binoculars"></i></Link>
                              <a onClick={showAlert} className="btn " style={{ backgroundColor: '#228b22', color: 'white' }}>Book Trip&nbsp;<i className="fa fa-shopping-cart"></i></a></div>
                          </div>
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-lg-4">
                        <div className="card" style={{ width: '20rem',margin:'20px auto' }}>
                          ...
                          <div className="card-body">
                            ...
                            <p style={{ textAlign: 'justify' }}>One of the most adored hill stations of Tamil Nadu situated in the Nilgiri Hills of the Western Ghats of southern India, Ooty, is often visited by innumerable tourists to enjoy the peace and calm.</p>
                            <div className="btn-flx" style={{display: 'flex', justifyContent: 'space-between'}}> <Link to='/kerala' className="btn " style={{ backgroundColor: '#54bce4', color: 'white' }}>See Details&nbsp;<i className="fa fa-binoculars"></i></Link>
                              <a onClick={showAlert} className="btn " style={{ backgroundColor: '#228b22', color: 'white' }}>Book Trip&nbsp;<i className="fa fa-shopping-cart"></i></a></div>
                          </div>
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-lg-4">
                        <div className="card" style={{ width: '20rem',margin:'20px auto' }}>
                          ...
                          <div className="card-body">
                            ...
                            <div className="btn-flx" style={{display: 'flex', justifyContent: 'space-between'}}> <Link to='/rajasthan' className="btn " style={{ backgroundColor: '#54bce4', color: 'white' }}>See Details&nbsp;<i className="fa fa-binoculars"></i></Link>
                              <a onClick={showAlert} className="btn " style={{ backgroundColor: '#228b22', color: 'white' }}>Book Trip&nbsp;<i className="fa fa-shopping-cart"></i></a></div>
                          </div>
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-lg-4">
                        <div className="card" style={{ width: '20rem',margin:'20px auto' }}>
                          ...
                          <div className="card-body">
                            ...
                            <p style={{ textAlign: 'justify' }}>The unique thing about the Ladakh terrain is that it has mountains, forests, deserts, lakes, rivers, waterfalls in one of the beautiful and dynamic geography. On a journey to the top of the world.</p>
                            <div className="btn-flx" style={{display: 'flex', justifyContent: 'space-between'}}> <Link to='/leh' className="btn " style={{ backgroundColor: '#54bce4', color: 'white' }}>See Details&nbsp;<i className="fa fa-binoculars"></i></Link>
                              <a onClick={showAlert} className="btn " style={{ backgroundColor: '#228b22', color: 'white' }}>Book Trip&nbsp;<i className="fa fa-shopping-cart"></i></a></div>
                          </div>
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-lg-4">
                        <div className="card" style={{ width: '20rem',margin:'20px auto' }}>
                          ...
                          <div className="card-body">
                            ...
                            <p style={{ textAlign: 'justify' }}>Coorg & Chikmagalur, located in the Western Ghats of Karnataka, is known for its scenic beauty, coffee plantations, trekking trails, wildlife sanctuaries, waterfalls, and historical sites.</p>
                            <div className="btn-flx" style={{display: 'flex', justifyContent: 'space-between'}}> <Link to='/manali' className="btn " style={{ backgroundColor: '#54bce4', color: 'white' }}>See Details&nbsp;<i className="fa fa-binoculars"></i></Link>
                              <a onClick={showAlert} className="btn " style={{ backgroundColor: '#228b22', color: 'white' }}>Book Trip&nbsp;<i className="fa fa-shopping-cart"></i></a></div>
                          </div>
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-lg-4">
                        <div className="card" style={{ width: '20rem',margin:'20px auto' }}>
                          ...
                          <div className="card-body">
                            ...
                            <p style={{ textAlign: 'justify' }}>The unique thing about the Ladakh terrain is that it has mountains, forests, deserts, lakes, rivers, waterfalls in one of the beautiful and dynamic geography. On a journey to the top of the world.</p>
                            <div className="btn-flx" style={{display: 'flex', justifyContent: 'space-between'}}> <Link to='/meghalaya' className="btn " style={{ backgroundColor: '#54bce4', color: 'white' }}>See Details&nbsp;<i className="fa fa-binoculars"></i></Link>
                              <a onClick={showAlert} className="btn " style={{ backgroundColor: '#228b22', color: 'white' }}>Book Trip&nbsp;<i className="fa fa-shopping-cart"></i></a></div>
                          </div>
                        </div>
                      </div>
