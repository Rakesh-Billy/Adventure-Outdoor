...
function User_Tour_8() {
  return (
    <> <div className={style.main1} style={{ backgroundImage: 'url(Images/background-manali.png)' }}>
        ...
        <div className="col-12 col-md-12 col-lg-12">
          <div className={style.text}>
            ...
            <div className={style.num_back}>
              <span><p1>₹ 13999.00 </p1><p2><s> ₹ 15500.00</s> / Per Person</p2></span>
            </div>
          </div>
        </div>
      </div>
