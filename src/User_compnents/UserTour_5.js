...
function User_Tour_5() {
  return (
    <> <div className={style.main1} style={{ backgroundImage: 'url(Images/background-kerala.png)' }}>
        ...
        <div className="col-12 col-md-12 col-lg-12">
          <div className={style.text}>
            ...
            <div className={style.num_back}>
              <span><p1>₹ 14999.00 </p1><p2><s> ₹ 16599.00</s> / Per Person</p2></span>
            </div>
          </div>
        </div>
      </div>
