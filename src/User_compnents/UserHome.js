  ...
  return (
    <div>
      ...
      <div className={style.main1}>
        ...
        <Link to='/user_tours'><button>Explore Trips</button></Link>
      </div>
                ...
                <div className="card" style={{ width: '20rem' }}>
                  ...
                  <div className="card-body">
                    ...
                    <div className={style.btn}>
                      <Link to='/user_goa' className="btn" style={{ backgroundColor: '#54bce4', color: 'white' }}>
                        See Details <i className="fa fa-binoculars"></i>
                      </Link>
                      <Link to='/checkout' className="btn"  style={{ backgroundColor: '#228b22', color: 'white' }}>
              ...
              <div className={style.card}>
                ...
                <div className="card" style={{ width: '20rem' }}>
                  ...
                  <div className="card-body">
                    ...
                    <div className={style.btn}>
                      <Link to='/user_leh' className="btn" style={{ backgroundColor: '#54bce4', color: 'white' }}>
                        See Details <i className="fa fa-binoculars"></i>
                      </Link>
                      <Link  className="btn"  style={{ backgroundColor: '#228b22', color: 'white' }}>
                        Book Trip <i className="fa fa-shopping-cart"></i>
                      </Link>
                    </div>
                  </div>
               ...
               <div className={style.card}>
                ...
                <div className="card" style={{ width: '20rem' }}>
                  ...
                  <div className="card-body">
                    ...
                    <div className={style.btn}>
                      <Link to='user_manali' className="btn" style={{ backgroundColor: '#54bce4', color: 'white' }}>
                        See Details <i className="fa fa-binoculars"></i>
                      </Link>
                      <Link to='/checkout'  className="btn" style={{ backgroundColor: '#228b22', color: 'white' }}>
                        Book Trip <i className="fa fa-shopping-cart"></i>
