...
function User_Tour_7() {
  return (
    <> <div className={style.main1} style={{ backgroundImage: 'url(Images/background-leh.png)' }}>
        ...
        <div className="col-12 col-md-12 col-lg-12">
          <div className={style.text}>
            ...
            <div className={style.num_back}>
              <span><p1>₹ 14999.00 </p1><p2><s> ₹ 15999.00</s> / Per Person</p2></span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="col-12 col-md-12 col-lg-8">
          ...
          <div className={style.Tour_Details}>
            <ul className="info-list clearfix" style={{display: 'flex', justifyContent: 'space-between', background: '#f5f6f6',  border: '1px solid #e6ebeb',  borderRadius: '8px', paddingTop:'30px',  padding: '15px',}}>
              <li id="tour_duration"><i className="far fa-clock"></i> 7 Days - 6 Nights</li>
              <p>|</p>
